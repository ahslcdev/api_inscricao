...
from app.apis.age_api.exceptions import AlreadyRegisteredAgeException, InvalidAgeException
...
from app.apis.age_api.utils import validate_ages
...
async def add_age_group(age: AgeGroup, 
    ...
    :params age: É o objeto de idades que se deseja inserir no banco de dados.
    """
    try:
