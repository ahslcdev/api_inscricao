...
def test_retrieve_age_group_failure(monkeypatch: pytest.MonkeyPatch,
    ...
    monkeypatch.setattr("app.age_api.service.AgeGroupService.get_by_id", replace_to_exception)
...
def test_list_age_group_failure(monkeypatch: pytest.MonkeyPatch, basic_auth_credentials):
    monkeypatch.setattr("app.age_api.service.AgeGroupService.get_instances", replace_to_exception)
